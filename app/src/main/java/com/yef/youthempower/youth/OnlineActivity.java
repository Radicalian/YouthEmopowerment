...
public class OnlineActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode == SIGN_IN_REQUEST_CODE)
        {
            ...
            {
                Snackbar.make(activity_online, "Successfully signed in.Welcome!", Snackbar.LENGTH_SHORT).show();
                displayChatMessage();
            }
            else{
                Snackbar.make(activity_online,"We couldn't sign you in.Please try again later", Snackbar.LENGTH_SHORT).show();
                finish();
            }
        }
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        emojIconActions = new EmojIconActions(getApplicationContext(),activity_online,emojiButton,emojiconEditText);
